                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-400 max-w-2xl mx-auto">
                                Pick a launcher, set up Fabric, use Melon Mod Manager, then install recommended mods and shaders
                            </p>
                        </div>

                        {/* Launchers Section */}
                        <section className="mb-16">
                            <h2 className="font-pixel text-xl md:text-2xl text-[#ff4757] mb-8 text-center">
                                🎮 RECOMMENDED LAUNCHERS
                            </h2>

                            {/* Premium Launchers */}
                            <div className="mb-8">
                                <h3 className="font-pixel text-base sm:text-lg text-[#ffa502] mb-4 flex items-center gap-2">
                                    ...
                                    <div className="flex items-start gap-4 mb-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <a
                                                ...
                                                className="inline-block w-full sm:w-auto text-center px-6 py-2 bg-[#ffa502] hover:bg-[#ff8c00] rounded-lg text-sm font-medium transition-all"
                                            >
                            ...
                            {/* Cracked Launchers */}
                            <div className="mb-8">
                                <h3 className="font-pixel text-base sm:text-lg text-[#5f27cd] mb-4 flex items-center gap-2">
                                    ...
                                    <div className="flex items-start gap-4 mb-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-block w-full sm:w-auto text-center px-6 py-2 bg-[#5f27cd] hover:bg-[#341f97] rounded-lg text-sm font-medium transition-all mb-6"
                                            >
                                                Download SKLauncher
                                            </a>
                                        </div>
                                ...
                                <div className="glass rounded-2xl p-6 border-2 border-[#5f27cd]/30">
                                    ...
                                    <div className="glass p-5 rounded-xl mb-4">
                                        ...
                                        <ol className="text-sm text-gray-300 space-y-2">
                                            <li className="flex items-start gap-3">
                                                <span className="text-[#5f27cd] font-bold min-w-[20px]">1.</span>
                                                <span>Download and install TLegacy</span>
                                            </li>
                                            <li className="flex items-start gap-3">
                                                <span className="text-[#5f27cd] font-bold min-w-[20px]">2.</span>
                                                <span>Open TLegacy and enter any username (no account needed)</span>
                                            </li>
                                            <li className="flex items-start gap-3">
                                                <span className="text-[#5f27cd] font-bold min-w-[20px]">3.</span>
                                    ...
                                    <div className="glass p-5 rounded-xl">
                                        ...
                                        <ol className="text-sm text-gray-300 space-y-2">
                                            ...
                                            <li className="flex items-start gap-3">
                                                <span className="text-[#ffa502] font-bold min-w-[20px]">2.</span>
                                                <span>In TLegacy, click the folder icon at the bottom</span>
                                            </li>
                                            <li className="flex items-start gap-3">
                                                <span className="text-[#ffa502] font-bold min-w-[20px]">3.</span>
                            ...
                            {/* Mod Setup Notes */}
                            <div className="glass rounded-2xl p-6 border-2 border-[#2ed573]/30 mb-8">
                                <h3 className="font-pixel text-base sm:text-lg text-[#2ed573] mb-3 flex items-center gap-2">
                                    <span>🧩</span> WANT TO ADD MODS TO YOUR LAUNCHER?
                                </h3>
                                <p className="text-gray-300 text-sm mb-4">
                                    Use <strong className="text-[#2ed573]">Fabric</strong> for the best compatibility and easiest setup.
                                </p>
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="glass p-4 rounded-xl border border-[#2ed573]/30">
                                        <p className="text-xs text-gray-400 mb-1">Server Fabric Version</p>
                                        <p className="text-sm text-white">
                                            Minecraft <strong className="text-[#ff4757]">{minecraftVersion}</strong> with <strong className="text-[#2ed573]">Fabric</strong>
                                        </p>
                                    </div>
                                    <div className="glass p-4 rounded-xl border border-[#ff4757]/30">
                                        <p className="text-xs text-gray-400 mb-2">Required Base Mod</p>
                                        <p className="text-sm text-gray-300 mb-3">Install Fabric API so most mods work correctly.</p>
                                        {requiredMods.map((mod) => (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-block w-full sm:w-auto text-center px-4 py-2 bg-[#ff4757] hover:bg-[#ff6b81] rounded-lg text-sm font-medium transition-all"
                                            >
                                                Download {mod.name}
                                            </a>
                                        ))}
                            ...
                            <div className="glass p-6 rounded-2xl border border-white/10 mb-8">
                                ...
                                <ol className="text-sm text-gray-300 space-y-2 list-decimal list-outside pl-5">
                                    <li>Install Fabric Loader from <a href="https://fabricmc.net/" target="_blank" rel="noopener noreferrer" className="link-primary">fabricmc.net</a></li>
                                    <li>Download all mods from links below (save to a folder)</li>
                            ...
                            <div className="glass rounded-2xl p-6 border-2 border-[#2ed573]/30 mb-8">
                                <div className="flex items-start gap-4 mb-4">
                                    <div className="text-4xl">🍉</div>
                                    <div className="flex-1">
                                        <h3 className="font-pixel text-base sm:text-lg leading-tight break-words text-[#2ed573] mb-2">MELON MOD MANAGER (WINDOWS APP)</h3>
                                        <p className="text-gray-300 text-sm mb-4">
                                            A custom desktop app to browse, install, and update Minecraft mods, shaders, and resource packs in one place.
                                        </p>
                                        <div className="flex flex-wrap gap-2 mb-4">
                                            <span className="glass px-3 py-1 rounded-full text-xs text-[#2ed573]">✓ Modrinth-powered downloads</span>
                                            <span className="glass px-3 py-1 rounded-full text-xs text-[#2ed573]">✓ Update checker</span>
                                            <span className="glass px-3 py-1 rounded-full text-xs text-[#2ed573]">✓ Built for Windows</span>
                                        </div>
                                        <div className="flex flex-wrap gap-3">
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-block w-full sm:w-auto text-center px-6 py-2 bg-[#2ed573] hover:bg-[#26b85f] rounded-lg text-sm font-medium transition-all"
                                            >
                                                Open GitHub Repo
                                            </a>
                                            <a
                                                href="https://github.com/xyrusL/melon_mod_manager/releases/latest"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-block w-full sm:w-auto text-center px-6 py-2 bg-[#ffa502] hover:bg-[#ff8c00] rounded-lg text-sm font-medium transition-all"
                                            >
                                ...
                                <div className="glass p-4 rounded-xl border border-[#2ed573]/30 mb-4">
                                    <h4 className="font-pixel text-sm text-[#2ed573] mb-2">WHAT IS MELON MOD MANAGER?</h4>
                                    <p className="text-sm text-gray-300">
                                        Melon Mod Manager is our custom Windows app that helps you manage mods, shaders, and resource packs faster without manually sorting files.
                                    </p>
                                </div>

                                <div className="glass p-3 rounded-xl border border-white/10">
                                    <p className="text-xs text-gray-400 mb-3">App Preview</p>
                                    <img
                                        src="https://raw.githubusercontent.com/xyrusL/melon_mod_manager/main/assets/screenshots/download_mod.png"
                                        alt="Melon Mod Manager app preview"
