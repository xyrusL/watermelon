          ...
          <div className="max-w-6xl mx-auto">
            <div className="glass rounded-2xl px-4 py-3 flex items-center justify-between">
              ...
              <nav className="flex items-center gap-3">
                <Link
                  href="/about"
                  className="px-4 py-2.5 glass border border-white/10 hover:border-[#5f27cd]/50 rounded-full text-sm font-medium transition-all hover:scale-105"
                >
                ...
                <Link
                  href="/commands"
                  className="px-4 py-2.5 glass border border-white/10 hover:border-[#2ed573]/50 rounded-full text-sm font-medium transition-all hover:scale-105"
                >
